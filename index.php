...
<head>
	...
	<title>challenge - thinkinnovation</title>
...
<body>
	<div id="main">
		...
		<section class="cream1">
			...
			<div>
				<h3>What is <span>D</span>ART<span>?</span></h3>
				<p>This short video (1mn) will introduce you to DART and how it can help you find the documents you are looking for.</p>
				<p><span>D</span>ART stands for "Document Archive Retrieval Tool" and was built in 2006 by the team with the same name. It is an extraordinary resource for all the BCS Regulatory community.</p>
			</div>
			<div id="tips1">
		...
		<section class="cream2">
			<h2>module 3</h2>
			
			<h3>Getting to know <span>D</span>ART better</h3>
		...
		<section class="red">
			<p><span>Almost done</span></p>
			<p>Now that you a pretty good idea of what <span>D</span>ART is and can it do for you, let's do a quick roundup:</p>
		</section>
